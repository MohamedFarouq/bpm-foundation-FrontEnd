...
//@Deprecated - dynamically retrieved from server
	class FormItem{
	...
	const properties = {
		english : {
			...
			somethingWentWrong : 'Something went wrong - Please contact 4040',
			logOff : "Log Off",
			...
			supercededForms : 'Superseded Forms',
		...
		arabic : {
			...
			somethingWentWrong : 'حدث خطأ بالنظـام، الرجـاء الاتصـال على 4040',
			logOff : "Log Off",
			...
			supercededForms : 'نماذج سابقة',
			cancelForm : 'إلغاء النموذج',

		}
	};

	//@Deprecated to be loaded dynamically
	...
	// @Deprecaated to be loaded dynamically
	const branchCatalog = {
